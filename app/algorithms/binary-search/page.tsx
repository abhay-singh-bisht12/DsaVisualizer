  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <Card className="p-6 mb-8 bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-950/30 dark:to-indigo-950/30">
        ...
        <div className="mb-6 p-4 rounded-lg border-2 border-purple-200 dark:border-purple-800 bg-white/50 dark:bg-slate-900/50">
          <h3 className="text-lg font-semibold mb-2 text-purple-800 dark:text-purple-300">Definition</h3>
          <p className="text-muted-foreground leading-relaxed">
            <strong>Binary Search</strong> is a divide-and-conquer search algorithm that finds the position of a target value in a <strong>sorted</strong> array by repeatedly comparing the target with the middle element of the current search range. If the target is smaller, the search continues in the left half; if larger, in the right half. This halves the search space each step, giving O(log n) time complexity.
          </p>
        </div>
      ...
      <Card className="p-6 mb-8">
        ...
        <div className="mb-6 p-4 rounded-lg border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50">
          ...
          <p className="text-muted-foreground leading-relaxed">
            <strong>Binary Search</strong> finds a target value in a sorted array by maintaining a search range <code className="bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">[left..right]</code>, repeatedly inspecting the middle element, and narrowing the range to the left or right half depending on the comparison. It returns the index of the target if found, or indicates absence when the range becomes empty.
          </p>
        </div>
        ...
        <ol className="list-decimal pl-6 space-y-4 text-muted-foreground">
          <li>
            <strong className="text-foreground">Initialize range.</strong> Set <code className="bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">left = 0</code>, <code className="bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">right = n − 1</code>. Ensure the array is sorted.
          </li>
          <li>
            <strong className="text-foreground">While <code className="bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">left ≤ right</code>:</strong> compute <code className="bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">mid = floor((left + right) / 2)</code>.
          </li>
          <li>
            <strong className="text-foreground">Compare with target.</strong> If <code className="bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">array[mid] === target</code>, return <code className="bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">mid</code> (found).
          </li>
          <li>
            <strong className="text-foreground">If <code className="bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">array[mid] &lt; target</code>:</strong> search right half — set <code className="bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">left = mid + 1</code>.
          </li>
          <li>
            <strong className="text-foreground">If <code className="bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">array[mid] &gt; target</code>:</strong> search left half — set <code className="bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">right = mid − 1</code>.
          </li>
          <li>
            <strong className="text-foreground">If the loop ends</strong> (range empty), the target is not in the array; return &quot;not found&quot;.
          </li>
        </ol>
        ...
        <div className="mt-6 flex justify-end">
          <CheatSheetDownload
            fileName="binary-search-cheatsheet.txt"
            title="Binary Search"
            definition="Binary Search finds a target value in a sorted array by repeatedly checking the middle element and discarding half of the search range based on comparison."
            steps={[
              "Ensure the array is sorted; set left = 0 and right = n−1.",
              "While left ≤ right, compute mid = floor((left + right) / 2).",
              "If array[mid] equals the target, return mid (found).",
              "If array[mid] < target, move left to mid + 1 (search right half).",
              "If array[mid] > target, move right to mid − 1 (search left half).",
              "If the range becomes empty, the target is not present.",
            ]}
          />
        </div>
      </Card>
